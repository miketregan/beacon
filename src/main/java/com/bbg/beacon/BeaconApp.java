package com.bbg.beacon;

import com.bbg.beacon.config.ApplicationProperties;
import com.bbg.beacon.config.DefaultProfileUtil;
...
public class BeaconApp {
    ...
    public BeaconApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(BeaconApp.class);
